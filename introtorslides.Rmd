...
Because R’s origins lie in statistical programming or analysis, and S is quite an old language, R is more of a functional than an object orientated language. R does have several object-orientated systems, but a lot of these are either under-the-hood, or are used for advanced programming. For most users (myself included), they’d stick to a predominantly functional paradigm, so in that respect it’s a bit easier for people not familiar with object-orientated systems to learn. 
